...
class Semanal(MRJob):
    ...
    def mapper(self, _, linea):
        #cálculo de los valores para el primer reducer
    ...
    def reducer(self, accion, valores):
        ...
        #obtención cotización inicial
        fecha_ini = cotizaciones[0][0]

        #obtención de las fechas para comprobar si pertenecen a la semana o al mes
        ...
        #recorrer todos los valores y ver si corresponden a semana,mes o solo a més
    ...
    def reducer_top5(self, tipo, valores):
        #obtener los cinco valores que más han subido ordenando la lista
